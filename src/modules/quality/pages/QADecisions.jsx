        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="sm:max-w-[500px]">
            ...
            <DialogFooter className="border-t border-slate-100 pt-4">
              ...
              <Button className="bg-[#b2ed1d] text-slate-900 hover:bg-[#8cd121] font-bold shadow-sm h-10 px-4 inline-flex items-center gap-2 min-w-[140px]" onClick={handleSubmit}>
                Confirm Decision
              </Button>
            </DialogFooter>
          </DialogContent>
