...
export default function InboundOrders() {
  ...
  // --- HELPER: DETECT PRODUCTION TYPE ---
  const isManufacturing = (type) => ['PROD_FG', 'PROD_SFG'].includes(type);
  ...
  const handleCreate = () => {
    // 1. Conditional Validation based on Type
    ...
    const payload = {
      ...newOrder,
      // Map 'supplier' field to Line ID if it's production (Unified Schema)
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            <DialogContent className="sm:max-w-[700px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {isManufacturing(newOrder.type) ? "Register Internal Production Output" : "Register External Supplier Document"}
                    </DialogDescription>
                </DialogHeader>
